...
class TestExtractGroups:
    ...
    def test_selected_groups(self):
        groups = _extract_groups(GENDER_SALARY, "gender", "salary", group_values=["M"])
...
class TestAnalyzeRouting:
    ...
    def test_spearman_correlation(self):
        def mock_fn(msgs):
            return (
                '{"test": "spearman", "x_column": "x", "y_column": "y",'
    ...
    def test_one_sample_ttest(self):
        def mock_fn(msgs):
            return (
                '{"test": "one_sample_ttest", "value_column": "salary",'
    ...
    def test_paired_ttest(self):
        ...
        def mock_fn(msgs):
            return (
                '{"test": "paired_ttest", "x_column": "before",'
                ' "y_column": "after", "alternative": "less", "confidence": 0.9}'
            )

        result = analyze(before_after, "Did before improve to after?", backend=mock_fn)
    ...
    def test_anova(self):
        ...
        def mock_fn(msgs):
            return (
                '{"test": "anova", "group_column": "region",'
    ...
    def test_mann_whitney(self):
        def mock_fn(msgs):
            return (
                '{"test": "mann_whitney", "group_column": "gender",'
    ...
    def test_kruskal_wallis(self):
        ...
        def mock_fn(msgs):
            return (
                '{"test": "kruskal_wallis", "group_column": "region",'
                ' "value_column": "score", "confidence": 0.85}'
            )
    ...
    def test_fisher_exact(self):
        ...
        def mock_fn(msgs):
            return (
                '{"test": "fisher", "x_column": "treatment",'
    ...
    def test_point_biserial(self):
        def mock_fn(msgs):
            return (
                '{"test": "point_biserial", "x_column": "salary",'
...
class TestAnalyzeBackends:
    ...
    def test_callable_backend(self):
        def my_fn(msgs):
            return (
                '{"test": "two_sample_ttest", "group_column": "gender",'
                ' "value_column": "salary", "alternative": "two-sided",'
                ' "confidence": 0.9}'
            )
    ...
    def test_alpha_forwarded(self):
        result = analyze(GENDER_SALARY, "Do males earn more?", backend=None, alpha=0.01)
...
class TestAnalyzeEdgeCases:
    ...
    def test_missing_column_raises(self):
        def mock_fn(msgs):
            return (
                '{"test": "two_sample_ttest", "group_column": "no_such_col",'
